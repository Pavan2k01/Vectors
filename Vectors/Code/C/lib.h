...
double **lin_solv(double **l1, double **l2, double **l3) {
    ...
    solution[2] = (double*)malloc(sizeof(double));

    double det = (l1[2][0] * l2[0][0] - l2[2][0] * l1[0][0]);
    double a = l1[1][0] * l2[0][0];
    double b = l2[1][0] * l1[0][0];
    double x = a - b;
    solution[0][0] = x / det;

    double c = l1[1][0] * l2[2][0];
    double d = l2[1][0] * l1[2][0];
    double y = c - d;
    solution[1][0] = y / det;
    solution[2][0] = det;
